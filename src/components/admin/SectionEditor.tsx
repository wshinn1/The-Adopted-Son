        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    max={2}
                    step={0.1}
                    value={formData.text_animation_duration ?? 0.5}
                    onChange={(e) => handleChange('text_animation_duration', Number(e.target.value))}
                    className="flex-1 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer accent-primary-600"
                  />
                  <span className="text-sm text-neutral-600 dark:text-neutral-400 w-12 text-right">
                    {formData.text_animation_duration ?? 0.5}s
                  </span>
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    max={0.5}
                    step={0.02}
                    value={formData.text_animation_stagger ?? 0.1}
                    onChange={(e) => handleChange('text_animation_stagger', Number(e.target.value))}
                    className="flex-1 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer accent-primary-600"
                  />
                  <span className="text-sm text-neutral-600 dark:text-neutral-400 w-12 text-right">
                    {formData.text_animation_stagger ?? 0.1}s
                  </span>
                </div>
                <p className="text-xs text-neutral-500 mt-1">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    max={30}
                    step={1}
                    value={formData.text_animation_blur ?? 10}
                    onChange={(e) => handleChange('text_animation_blur', Number(e.target.value))}
                    className="flex-1 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer accent-primary-600"
                  />
                  <span className="text-sm text-neutral-600 dark:text-neutral-400 w-12 text-right">
                    {formData.text_animation_blur ?? 10}px
                  </span>
                </div>
                <p className="text-xs text-neutral-500 mt-1">
                  Initial blur before reveal.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    max={5}
                    step={0.1}
                    value={formData.subheadline_animation_delay ?? 1.5}
                    onChange={(e) => handleChange('subheadline_animation_delay', Number(e.target.value))}
                    className="flex-1 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer accent-primary-600"
                  />
                  <span className="text-sm text-neutral-600 dark:text-neutral-400 w-12 text-right">
                    {formData.subheadline_animation_delay ?? 1.5}s
                  </span>
                </div>
                <p className="text-xs text-neutral-500 mt-1">
                  Delay before subheadline starts (after hero text).
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    max={1}
                    step={0.05}
                    value={formData.subheadline_animation_speed ?? 0.35}
                    onChange={(e) => handleChange('subheadline_animation_speed', Number(e.target.value))}
                    className="flex-1 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer accent-primary-600"
                  />
                  <span className="text-sm text-neutral-600 dark:text-neutral-400 w-12 text-right">
                    {formData.subheadline_animation_speed ?? 0.35}s
                  </span>
                </div>
                <p className="text-xs text-neutral-500 mt-1">
                  Duration for each word to appear.
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    max={30}
                    step={1}
                    value={formData.subheadline_animation_blur ?? 10}
                    onChange={(e) => handleChange('subheadline_animation_blur', Number(e.target.value))}
                    className="flex-1 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer accent-primary-600"
                  />
                  <span className="text-sm text-neutral-600 dark:text-neutral-400 w-12 text-right">
                    {formData.subheadline_animation_blur ?? 10}px
                  </span>
                </div>
                <p className="text-xs text-neutral-500 mt-1">
                  Initial blur before reveal.
          ...
          <div className="pt-4 border-t border-neutral-200 dark:border-neutral-700">
            ...
            <div className="mt-6 pt-4 border-t border-neutral-100 dark:border-neutral-800">
              <h5 className="text-sm font-medium text-neutral-600 dark:text-neutral-400 mb-4">
                Glass Effect
              </h5>
              <div className="grid gap-4 md:grid-cols-3">
                <div>
                  ...
                  <input
                    type="number"
                    value={formData.arrow_delay_seconds ?? 2}
                    onChange={(e) => handleChange('arrow_delay_seconds', Number(e.target.value))}
                    min={0}
                    max={10}
                    step={0.5}
                    className="w-full px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 text-sm"
                  />
                  <p className="text-xs text-neutral-400 mt-1">Fade-in delay</p>
                </div>
                <div>
                  <label className="block text-xs text-neutral-500 mb-1">
                    Glass Opacity (0-1)
                  ...
                  <input
                    type="number"
                    value={formData.arrow_glass_opacity ?? 0.2}
                    onChange={(e) => handleChange('arrow_glass_opacity', Number(e.target.value))}
                    min={0}
                    max={1}
                    step={0.05}
                    className="w-full px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 text-sm"
                  />
                  <p className="text-xs text-neutral-400 mt-1">Background overlay</p>
                </div>
                <div>
                  <label className="block text-xs text-neutral-500 mb-1">
                    Blur Amount (px)
                  ...
                  <input
                    type="number"
                    value={formData.arrow_glass_blur ?? 10}
                    onChange={(e) => handleChange('arrow_glass_blur', Number(e.target.value))}
                    min={0}
                    max={30}
                    step={1}
                    className="w-full px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 text-sm"
